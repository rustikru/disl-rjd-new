...
var BASE_COLS = [
  ...
  // ============================================================
  { key: 'wagon_no', label: '№ вагона', meta: true, type: 'number', w: 110, tab: 'main', showInline: false},
  { key: 'wagon_type_code', label: 'Тип вагона', meta: true, w: 120, tab: 'main', showInline: false},
  { key: 'wagon_state', label: 'Состояние вагона', meta: true, w: 130, tab: 'main', showInline: false},
  { key: 'oper_station', label: 'Тек. станция', meta: true, w: 150, tab: 'main', showInline: false},
  { key: 'oper_mnemonic', label: 'Операция', meta: true, w: 90, tab: 'main', showInline: false},
  { key: 'idle_time_days', label: 'Простой (сут.)', right: true, w: 100, tab: 'main', showInline: false},
  { key: 'dest_station', label: 'Ст. назнач.', meta: true, w: 145, tab: 'main', showInline: false},
  { key: 'cargo_name', label: 'Груз', meta: true, w: 150, tab: 'main', showInline: false},
  { key: 'norm_delivery_dt', label: 'Срок доставки', meta: true, w: 130, tab: 'main', showInline: false},

  // ============================================================
  // ВКЛАДКА: ДАННЫЕ О ВАГОНЕ (data-wagon) — раздел 1 справки (кол. 1–31)
  // ============================================================
  // — оперативные (showInline: true) —
  { key: 'waybill_no', label: '№ накладной', meta: true, w: 100, tab: 'data-wagon', showInline: false},
  { key: 'cargo_weight_kg', label: 'Вес (кг)', right: true, w: 100, tab: 'data-wagon', showInline: false},
  { key: 'container_nos', label: 'Номера контейнеров', right: true, w: 120, tab: 'data-wagon', showInline: false},
  { key: 'consignor_name', label: 'Грузоотправитель', meta: true, w: 150, tab: 'data-wagon', showInline: false},
  { key: 'consignee_name', label: 'Грузополучатель', meta: true, w: 150, tab: 'data-wagon', showInline: false},
  ...
  // ============================================================
  // — оперативные (showInline: true) —
  { key: 'depart_station', label: 'Ст. отправл.', meta: true, w: 145, tab: 'disl-wagon', showInline: false},
  { key: 'oper_road', label: 'Дорога опер.', meta: true, w: 120, tab: 'disl-wagon', showInline: false},
  { key: 'oper_dt', label: 'Дата операции', meta: true, w: 130, formatData: 'DD.MM.YYYY HH24:MI:SS', tab: 'disl-wagon', showInline: false},
  { key: 'train_index', label: 'Индекс поезда', meta: true, w: 130, tab: 'disl-wagon', showInline: false},
  { key: 'train_no', label: 'Поезд №', meta: true, w: 90, tab: 'disl-wagon', showInline: false},
  ...
  { key: 'depart_road', label: 'Дорога отправл.', meta: true, w: 130, tab: 'disl-wagon', showInline: false},
  { key: 'dest_road', label: 'Дорога назнач.', meta: true, w: 130, tab: 'disl-wagon', showInline: false},
  ...
  { key: 'idle_time_hhmmss', label: 'Простой (ЧЧ:ММ:СС)', meta: true, w: 130, tab: 'disl-wagon', showInline: false},
  { key: 'asoup_depart_dt', label: 'Отпр. (АСОУП)', meta: true, w: 130, formatData: 'DD.MM.YYYY HH24:MI:SS', tab: 'disl-wagon', showInline: false},
  { key: 'asoup_arrive_dt', label: 'Приб. (АСОУП)', meta: true, w: 130, formatData: 'DD.MM.YYYY HH24:MI:SS', tab: 'disl-wagon', showInline: false},
