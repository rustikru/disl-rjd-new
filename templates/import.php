...
<head>
  ...
  <style>
    ...
    .upload-hint { font-size:12px; color:var(--text-muted,#9DA5B0); margin-top:6px; }
      ...
      <form method="POST" action="/import" enctype="multipart/form-data">
        <div style="margin-bottom:18px">
          ...
          <div class="upload-hint">
            Файл отчёта «Личный кабинет клиента» РЖД — 126 колонок, дата справки считывается автоматически из ячейки A2.
